...
function buildAssessmentReportFromScorecard(
  ...
  return {
    ...
    summary: buildSummary(submission.taskType, scorecard.overallBandRange, submission.wordCount),
    ...
    warnings: buildWarnings(submission.taskType, submission.wordCount, scorecard.confidence),
