    ...
    steps: [
      {
        ...
        phase: 'benchmark',
        status: 'current',
        completionSignal: 'One scored Task 1 report is saved.',
        moduleLabel: 'Writing',
        criterion: 'Overall',
        taskType: 'task-1',
        targetRange: null,
      ...
      },
      {
        ...
        phase: 'benchmark',
        status: 'locked',
        completionSignal: 'One scored Task 2 report is saved.',
        moduleLabel: 'Writing',
        criterion: 'Overall',
        taskType: 'task-2',
        targetRange: null,
      ...
      },
      {
        ...
        phase: 'complete',
        status: 'locked',
        completionSignal: 'Both benchmark reports have been reviewed before the next draft.',
        moduleLabel: 'Writing',
        criterion: 'Overall',
        taskType: 'either',
        targetRange: null,
...
function buildTaskCoverageStep(taskType: WritingTaskType, prompts: WritingPrompt[]): StudyPlanStep {
  ...
  return {
    ...
    phase: 'next-block',
    status: 'locked',
    completionSignal: `Save one scored ${formatTaskLabel(taskType)} response.`,
    moduleLabel: 'Writing',
    criterion: 'Overall',
    taskType,
    targetRange: null,
...
function buildPacingStep(
  ...
  return {
    ...
    phase: 'complete',
    status: 'locked',
    completionSignal: 'A complete timed response is saved without under-length warnings.',
    moduleLabel: 'Writing',
    criterion: 'Overall',
    taskType: 'either',
...
function buildWeaknessRepairStep(
  ...
  return {
    ...
    phase: 'daily-session',
    status: 'current',
    completionSignal: weakestCriterion
      ? `${weakestCriterion.criterion} improves by 0.5 band or stops appearing as the weakest criterion.`
      : 'The latest saved feedback has been applied in a new timed attempt.',
    moduleLabel: 'Writing',
