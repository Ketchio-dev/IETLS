...
- `docs/review/writing-dashboard-criterion-trends-review.md` — review/documentation note for the next dashboard slice: criterion-trend summaries plus saved-attempt compare support on `/dashboard`.
...
- The dashboard summarizes recent saved attempts, scorer usage, task coverage, and a lightweight study plan without adding dependencies.
- The next dashboard review note now documents how criterion-trend summaries and saved-attempt compare support should extend that same persistence-first flow.
